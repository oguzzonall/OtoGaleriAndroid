...
public class DogrulamaActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dogrulamaKodu=bundle.getString("kod");
    ...
    {
        Call<DogrulamaPojo> request=ManagerAll.getGetInstanse().dogrula(ad,kod);
        request.enqueue(new Callback<DogrulamaPojo>() {
            ...
            public void onResponse(Call<DogrulamaPojo> call, Response<DogrulamaPojo> response) {
                ...
                if(response.body().isTf())
                {
                    ...
                    Toast.makeText(DogrulamaActivity.this, response.body().getResult(), Toast.LENGTH_LONG).show();
                }
            }
