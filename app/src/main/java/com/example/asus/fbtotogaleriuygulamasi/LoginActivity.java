...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public void login(String ad, String sifre) {
        Call<LoginPojo> loginrequest = ManagerAll.getGetInstanse().login(ad, sifre);
        loginrequest.enqueue(new Callback<LoginPojo>() {
            @Override
            public void onResponse(Call<LoginPojo> call, Response<LoginPojo> response) {
                if (response.isSuccessful()) {
                    if (response.body().getKadi() != null && response.body().getId() != 0) {

                        int uyeId = response.body().getId();
                        ...
                        Toast.makeText(LoginActivity.this, "Bilgilerinizi Kontrol Ediniz..", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(LoginActivity.this, "Basarısızzzzz", Toast.LENGTH_SHORT).show();
                }
            }
